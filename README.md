...
7. There are more identations to be fixed in the code
8. An error showing for using second time id="user-options" comes from included files - main-nav and mobile-top-header, included one after another.
9. Couldn't load properly the Table from Manual Testing, sorry
</details>
...
<details><summary>Manual testing table</summary>
...
Paste in Python code from .....project files and click Check Code 
